...
# saver.restore(s, os.path.abspath("weights_11"))
...
show_valid_example(val_img_fns, example_idx=2)
...
show_valid_example(val_img_fns, example_idx=22)
...
show_valid_example(val_img_fns, example_idx=41)


# In[123]:


show_valid_example(val_img_fns, example_idx=43)
...
show_valid_example(val_img_fns, example_idx=46)


# In[127]:


show_valid_example(val_img_fns, example_idx=47)
